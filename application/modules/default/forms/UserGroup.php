<?php
class Default_Form_UserGroup extends Zend_Form {
	...
	public function _getModules() {
		...
		$select = $moduleMapper->getDbTable()->select()
					->setIntegrityCheck(false)
					->from(array("m"=>"module"),array("m.module_id","m.name"))
					->join(array("ugm"=>"user_group_module"), "m.module_id = ugm.module_id AND ugm.user_group_id = ".$user_group_id);
